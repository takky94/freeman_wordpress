    ...
    <article id="article" <?php post_class(); ?>>
      ...
      <div id="content">
        <div class="container">
          ...
          <?php if ($category_parent_slug == "jewelry" ) get_template_part('/parts/category-top/children/jewelry'); ?>
          <?php if ($category_parent_slug !== "jewelry" ) get_template_part('/parts/category-top/children/others'); ?>
        </div>
      </div>
    </article>
  </main>
