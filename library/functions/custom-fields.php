...
<tr class="form-field parent-others">
  <th><label for="othersImage">アイキャッチ画像</label></th>
  <td>
    <div style="display:flex">
    ...
    <p class="description">横600px:縦400px以上のサイズの画像を設定してください。ここで設定された画像はカテゴリページで表示されませんが、カテゴリへのリンクなどでのアイキャッチ画像として使用されます</p>
